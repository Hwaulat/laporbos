...
import { cn } from '@/lib/utils'; // Note: Changed to @/lib/utils to match standard shadcn/ui setup
...
const variants: Record<TabVariant, VariantConfig> = {
  ...
  primary: {
    list: 'bg-[#F3F4F6] dark:bg-gray-700/60 rounded-[14px] p-1 h-auto',
    triggerBase:
      'text-sm font-medium text-[#6A7282] dark:text-gray-400 rounded-[10px] data-[state=inactive]:hover:text-gray-700 dark:data-[state=inactive]:hover:text-gray-300',
    triggerActive:
    ...
    triggerSize: 'h-[32px] w-fit py-[6px] px-4',
  },
  dynamic: {
    listWrapper:
